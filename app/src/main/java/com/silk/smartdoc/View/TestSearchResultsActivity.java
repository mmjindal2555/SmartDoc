...
public class TestSearchResultsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        diagnosticCentreListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                String centerName = diagnosticCentersResultArrayList.get(position).getName();
                String centerUrl = diagnosticCentersResultArrayList.get(position).getUrl();

                Intent intent = new Intent(TestSearchResultsActivity.this,CentreWebsite.class);
                intent.putExtra("centerName",centerName);
                intent.putExtra("centerUrl",centerUrl);
